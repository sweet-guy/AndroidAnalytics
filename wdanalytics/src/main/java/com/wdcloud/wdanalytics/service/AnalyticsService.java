            ...
            if (msg.what == SELECT_MSG) {
                ...
                if (eventBeans.size() > 0) {
                    ...
                    for (int i = 0; i < eventBeans.size(); i++) {
                        ...
                        eventBean.setType(setNoEmpty(eventBeans.get(i).getType()));
                        eventBean.setTime(setNoEmpty(eventBeans.get(i).getTime()));
                        eventBean.setDuration(setNoEmpty(eventBeans.get(i).getDuration()));
                        if(!eventId.equals(""))
                        {
                        ...
                        if(!customInfo.equals(""))
                        {
                            ...
                            eventBean.setProPertiesBean(proPertiesBean);
                        }
                ...
                if (crashAnalyticsBeans.size() > 0) {
                    ...
                    for (int i = 0; i < crashAnalyticsBeans.size(); i++) {
                        ...
                        crashAnalyticsBean.setNetState(crashAnalyticsBeans.get(i).getNetState());
